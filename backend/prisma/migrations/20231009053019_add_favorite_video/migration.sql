...
CREATE TABLE `FavoriteVideo` (
    ...
    UNIQUE INDEX `FavoriteVideo_user_id_course_id_video_id_key`(`user_id`, `course_id`, `video_id`)
...
-- AddForeignKey
ALTER TABLE `FavoriteVideo` ADD CONSTRAINT `FavoriteVideo_course_id_fkey` FOREIGN KEY (`course_id`) REFERENCES `Course`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
